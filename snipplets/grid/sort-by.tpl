...
{% if list %}
	<div class="js-sort-by-list radio-button-container pb-2"> 
...
{% else %}
	<div class="pb-2">
		<h6 class="font-big mb-3 font-weight-bold">{{ "Ordenar" | translate }}</h6>

		{% embed "snipplets/forms/form-select.tpl" with{select_label: false, select_group_custom_class: "d-inline-block mb-0", select_custom_class: 'js-sort-by form-select-small', select_aria_label: 'Ordenar por:' | translate } %}

...
{% set show_filters = products or has_filters_available %}
    <div class="d-flex flex-column">
        {% if has_applied_filters and (category_page or search_page_filters) %}
            <div class="col-md-auto mb-3 mb-md-4 visible-when-content-ready {% if products %}d-none{% endif %} {% if not settings.filters_desktop_modal %}d-md-block{% endif %}">
                {{ component(
                    ...
                    {{ component(
                        'filters/filters',{
                            ...
                            accordion_classes: {
                                ...
                                title_col: "col my-1 d-flex align-items-center",
                                title: "h6 font-body font-weight-bold mb-0 filter-title",
                                actions_col: "col-auto my-1",
                                title_icon: "icon-inline svg-icon-text font-big"
                            },
                            filter_classes: {
                                ...
                                checkbox_last: "m-0",
                                price_group: 'price-filter-container filter-accordion p-2',
                                price_title: 'font-weight-bold mb-2 font-body',
                                price_submit: 'btn btn-default d-inline-block',
                                price_group: 'price-filter-container p-2',
                                price_title: 'h6 font-weight-bold mb-2 font-big',
                                price_submit: 'btn btn-default btn-small'
                            },
                            accordion_show_svg_id: 'accordion-arrow-down',
                            accordion_hide_svg_id: 'accordion-arrow-up',
                        })
                    }}
                {% endif %}
            </div>

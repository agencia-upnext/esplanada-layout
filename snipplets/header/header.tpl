    ...
    <div class="head-logo-row position-relative">
        <div class="container">
            <div class="{% if not settings.head_fix_desktop %}js-nav-logo-bar{% endif %} row no-gutters align-items-center">
                ...
                <a class="d-flex align-items-center header-whatsapp-button" href="https://api.whatsapp.com/send?phone=5511974694935" target="_blank">
                    <svg width="31" height="31" viewBox="0 0 31 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M0.661348 15.3653C0.660621 17.9786 1.3465 20.5302 2.65068 22.7793L0.536621 30.4637L8.43581 28.4017C10.6206 29.5858 13.0685 30.2062 15.5561 30.2064H15.5627C23.7746 30.2064 30.4594 23.5539 30.4629 15.377C30.4645 11.4147 28.9159 7.68888 26.1024 4.88575C23.2894 2.08285 19.5482 0.538429 15.5621 0.536621C7.34911 0.536621 0.664859 7.18882 0.661469 15.3653" fill="url(#paint0_linear_3299_2775)"/>
                            <path d="M0.12957 15.3606C0.128723 18.0679 0.83918 20.7108 2.18986 23.0404L0 31.0002L8.18243 28.8644C10.4369 30.0881 12.9753 30.7333 15.5582 30.7343H15.5649C24.0715 30.7343 30.9964 23.8424 31 15.3729C31.0015 11.2682 29.3972 7.40844 26.4832 4.50488C23.5688 1.60169 19.6938 0.00168776 15.5649 0C7.05686 0 0.132961 6.8909 0.12957 15.3606ZM5.0025 22.6392L4.69698 22.1564C3.41266 20.1233 2.73478 17.774 2.73575 15.3615C2.73841 8.32176 8.49327 2.59433 15.5698 2.59433C18.9967 2.59578 22.2173 3.92574 24.6397 6.33876C27.0619 8.75202 28.3948 11.96 28.3939 15.3719C28.3908 22.4117 22.6358 28.1398 15.5649 28.1398H15.5598C13.2575 28.1386 10.9994 27.5231 9.0302 26.3599L8.56157 26.0832L3.70595 27.3506L5.0025 22.6392Z" fill="url(#paint1_linear_3299_2775)"/>
                            <path d="M11.7071 8.93895C11.4182 8.29965 11.1141 8.28675 10.8394 8.27553C10.6144 8.26589 10.3572 8.26661 10.1002 8.26661C9.843 8.26661 9.42511 8.36294 9.07188 8.7469C8.71828 9.13123 7.72192 10.06 7.72192 11.949C7.72192 13.8379 9.10397 15.6636 9.29663 15.92C9.48953 16.176 11.9647 20.1764 15.8847 21.7154C19.1426 22.9944 19.8056 22.74 20.5127 22.6759C21.2199 22.612 22.7946 21.7474 23.1158 20.8508C23.4373 19.9544 23.4374 19.186 23.341 19.0254C23.2446 18.8654 22.9874 18.7693 22.6017 18.5774C22.216 18.3855 20.3198 17.4565 19.9663 17.3283C19.6127 17.2003 19.3556 17.1364 19.0984 17.5209C18.8412 17.9047 18.1027 18.7693 17.8776 19.0254C17.6527 19.282 17.4276 19.314 17.042 19.1219C16.6561 18.9293 15.414 18.5244 13.9405 17.2165C12.7939 16.1987 12.0199 14.942 11.7949 14.5575C11.5699 14.1737 11.7708 13.9656 11.9642 13.7743C12.1375 13.6022 12.35 13.3259 12.543 13.1018C12.7353 12.8776 12.7995 12.7176 12.9281 12.4616C13.0568 12.2053 12.9924 11.981 12.8961 11.789C12.7995 11.5969 12.0501 9.69808 11.7071 8.93895Z" fill="white"/>
                            <defs>
                            <linearGradient id="paint0_linear_3299_2775" x1="1496.85" y1="2993.24" x2="1496.85" y2="0.536621" gradientUnits="userSpaceOnUse">
                            <stop stop-color="#1FAF38"/>
                            <stop offset="1" stop-color="#60D669"/>
                            </linearGradient>
                            <linearGradient id="paint1_linear_3299_2775" x1="1550" y1="3100.02" x2="1550" y2="0" gradientUnits="userSpaceOnUse">
                            <stop stop-color="#F9F9F9"/>
                            <stop offset="1" stop-color="white"/>
                            </linearGradient>
                            </defs>
                        </svg>
                        <p>Compre pelo <br>Whatsapp</p>
                </a>

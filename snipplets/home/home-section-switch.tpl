{% if section_select == 'slider' %}
	...
	<section class="js-main-slider-section{% if not settings.slider_full %} section-home{% endif %}" data-store="home-slider" data-transition="fade-in" {% if head_transparent_section %}data-header-type="transparent-on-section"{% endif %}>
...
{% elseif section_select == 'promotional' %}
	...
	<section class="js-section-banner-home section-home section-banners-home promotional-banners position-relative overflow-none {{ section_without_margins }}" data-store="home-banner-promotional" data-transition="fade-in-up">

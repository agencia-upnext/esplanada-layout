							...
							{% endif %}
									<ul class="list py-2">
										<li class="footer-menu-item">
											<a class="footer-menu-link" href="#">Telefone Pós Venda</a>
										</li>
										<li class="footer-menu-item">
											<a class="footer-menu-link" href="#">WhatsApp Assistência Técnica</a>
										</li>
										<li class="footer-menu-item">
											<a class="footer-menu-link" href="#">Compre Pelo WhatsApp</a>
										</li>
										<li class="footer-menu-item">
											<a class="footer-menu-link" href="#">Televendas 0800-7706929</a>
										</li>
									</ul>
							{% if settings.footer_menus_toggle %}
								</div>

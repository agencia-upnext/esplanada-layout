...
{% endif %}
		<div class="{% if not thumb and not product_native_video %}js-video{% endif %} {% if product_video and not product_modal %}js-video-product{% endif %} {% if not thumb %}embed-responsive embed-responsive-16by9{% endif %} visible-when-content-ready position-relative">
			{% if not thumb %}
